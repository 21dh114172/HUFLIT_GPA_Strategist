...
(function() {
  ...
  // If user explicitly chose Next.js, stay here
  if (p === 'nextjs') return;

  // Otherwise (if preference is 'legacy' OR not set), default to legacy version
  // We check the pathname to prevent redirect loops if already on a legacy-prefixed path
